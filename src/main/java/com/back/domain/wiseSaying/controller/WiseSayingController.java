...
public class WiseSayingController {
    ...
    public String write(@RequestParam String content, @RequestParam String author) {
        ...
        if(content.isBlank()) {
            throw new IllegalAccessException("content is empty");
        }
        ...
        return "%d번의 명언이 생성되었습니다.".formatted(wiseSaying.getId());
    }
    ...
    public String modify(
        ...
        WiseSaying wiseSaying = wiseSayingService.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("%d번 명언은 존재하지 않습니다."));
